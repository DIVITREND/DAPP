...
export interface DivitrendFactoriesInterface extends utils.Interface {
  functions: {
    "adminMint(uint16,address)": FunctionFragment;
    ...
    "getTotalBoosts(uint16[])": FunctionFragment;
  ...
  events: {
    ...
    "NftMinted(address,uint16[])": EventFragment;
    "NftPayed(address,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "NftPayed"): EventFragment;
...
export interface NftPayedEventObject {
  account: string;
  amount: BigNumber;
}
export type NftPayedEvent = TypedEvent<
  [string, BigNumber],
  NftPayedEventObject
>;

export type NftPayedEventFilter = TypedEventFilter<NftPayedEvent>;
...
export interface DivitrendFactories extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DivitrendFactoriesInterface;
